        ...
        <el-tabs type="card" style=" border: 1px solid #C0C4CC"  class="table_lsc">
                <el-tab-pane label="内容">
                    <el-row :gutter="20">
                        ...
                        <el-table-column prop="name" label="折扣前单价" width="110"></el-table-column>
...
<el-form :label-position="labelPosition" label-width="100px" :model="formLabelAlign" size="mini" style="margin-top:20px;">
  ...
  <el-col>
    ...
    <el-dropdown-item disabled>单据转况查询</el-dropdown-item>
    ...
    <el-dropdown-menu slot="dropdown">
    <el-dropdown-item disabled>销售出库转入</el-dropdown-item>
