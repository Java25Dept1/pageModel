...
<template>
    ...
    <commonHead></commonHead>
       ...
       <el-row :gutter="20">
           <el-col :span="12">  
              ...
              <el-col :span="12">  
               <el-form-item label="单据类型">
                    <el-select v-model="grouping" placeholder="" style="width:100%;">
                         <el-option label="销售发票" value="8"></el-option>
                         <el-option label="退货及分析证明" value="9"></el-option>
                    </el-select>
                   </el-form-item>
            </el-col>
              <el-col :span="12">  
            ...
            <el-col :span="12">  
               <el-form-item label="销售核对状态">
                    <el-select v-model="grouping"  style="width:100%;">
                         <el-option label="未核对" value="8"></el-option>
                         <el-option label="已核对" value="9"></el-option>
                         </el-select>
                   </el-form-item>
            </el-col>
              <el-col :span="12">  
               <el-form-item label="币别">
                         <el-input v-model="input" placeholder="RMB 人民币"></el-input>
                   </el-form-item>
            </el-col>
            <el-col :span="12"> 
        ...
        <el-tabs type="card" style=" border: 1px solid #C0C4CC"  class="table_lsc">
            ...
            <el-table :data="tableData" border style="width: 100%" :summary-method="getSummaries" show-summary >
                        ...
                        <el-table-column prop="name" label="(未出数量)" width="90"></el-table-column>
                        <el-table-column prop="name" label="(销售订单号)" width="110"></el-table-column>
                        <el-table-column prop="name" label="分类备注" width="110">
                            <template scope="scope">
                                <el-input v-model="scope.row.address" placeholder="请输入内容" ></el-input>
                            </template>
                        </el-table-column>
        ...
        <el-row :gutter="20">
            ...
            <el-table :data="tableData">
                 <el-table-column prop="date" label="(栏号)" width="140"></el-table-column>
                 <el-table-column prop="name" label="物料编号" width="120"></el-table-column>
                ...
                <el-table-column prop="address" label="(折数%)"></el-table-column>
                ...
                <el-table-column prop="address" label="(税额)"></el-table-column>
                <el-table-column prop="address" label="(含税金额)"></el-table-column>
                <el-table-column prop="address" label="(批号)"></el-table-column>
                <el-table-column prop="address" label="赠品"></el-table-column>
                <el-table-column prop="address" label="(发票明细)"></el-table-column>
                <el-table-column prop="address" label="(未开票数量)"></el-table-column>
                <el-table-column prop="address" label="(分录备注)"></el-table-column>
                <el-table-column prop="address" label="(来源单别)"></el-table-column>
        ...
        <el-row :gutter="20">
            ...
            <el-col :span="12">  
               <el-form-item label="结算方式一">
                   <el-input v-model="input" style="width: 50%"></el-input>
                   <el-input v-model="input" style="width: 50%"></el-input>
                   </el-form-item>
            </el-col>
             <el-col :span="12">  
...
<el-form :label-position="labelPosition" label-width="100px" :model="formLabelAlign" size="mini" style="margin-top:20px;">
  ...
  <el-col>
    ...
    <el-dropdown-menu slot="dropdown">
        ...
        <el-dropdown-item disabled>转销售出库</el-dropdown-item>
  </el-dropdown-menu>
  </el-dropdown>
     <el-dropdown style="boder:1px bule">
          <el-button style="margin-left:25px;color:black;font-size: 10px;boder:1px dodgerblue solid;background-color: dodgerblue;" class="el-dropdown-link">
