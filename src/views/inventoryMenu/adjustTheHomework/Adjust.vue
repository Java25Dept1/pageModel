        ...
        <el-row class="border">
            ...
            <el-row class="border1">
                <el-row style="margin:5px 0px;font-size:14px;">
                    <el-col :span="8">
                        <div style="color:#919191;">
                           <span>单据编号：</span><el-input v-model="input" :disabled="true" size="mini" style="width:250px;" placeholder="保存订单自动生成"></el-input>
                        </div>
                    </el-col>
                ...
                <el-row style="margin:5px 0px;font-size:14px;">
                    <el-col :span="8"><div><span>制单人： </span><el-input v-model="input9" size="mini" style="width:250px;" placeholder="请输入内容"></el-input></div></el-col>
                    <el-col :span="8"><div><span>制单日期*：</span> <el-date-picker v-model="value2" align="right" size="mini" style="width:250px;" type="date" placeholder="选择日期" :picker-options="pickerOptions"></el-date-picker></div></el-col>
                </el-row>
            </el-row>
        </el-row>
        <el-row class='border' style="margin-top:20px;">
                        ...
                        <el-table-column prop="name" width="150px" label="物品编号*">
                            <template slot-scope="{row,$index}">
                                <div  @click="{{changeNum($index)}}">
                                    <el-input @focus="dialogTableVisible2 = true" size="mini" @blur="dis()" v-if="editable[$index]" v-model='row.name'></el-input>
                                    <span v-else v-text="row.name"></span>
                                </div>
                            </template>
                        </el-table-column>
                        <el-table-column prop="date"  width="160px" label="物品名称" class-name="column-bg-color-editable" show-overflow-tooltip>
                        </el-table-column>
            ...
            <el-row style="margin:5px 0px;font-size:14px;">
                <el-col :span="24" style="text-align:left;">
                    <div>
                        <span>备注：</span>
                        <el-input type="textarea" style="width:1375px;" :rows="3" v-model="textarea"></el-input>
                    </div>
                </el-col>
            </el-row>
        </el-row>
