      ...
      <el-row >
          ...
          <el-col :span="12">
            <div class="el-dropdown-link">
              ...
              <el-select size="mini" style="width:350px;" v-model="value" placeholder="请选择">
                <el-option key="1" label="平衡需要" value="1"></el-option>
                <el-option key="2" label="货物短缺" value="2"></el-option>
              </el-select>
            </div>
          </el-col>
          <el-col :span="12">
        ...
        <el-row style="margin:5px 0px;font-size:14px;">
          <el-col :span="12">
            <div>
              <span>调出仓库*：</span>
              <el-input v-model="input8" size="mini" style="width:350px;" placeholder="请选择">
                <el-button @click="dialogTableVisible4 = true" slot="append" icon="el-icon-search"></el-button>
              </el-input>
            </div>
          </el-col>
        ...
        <el-row style="margin:5px 0px;font-size:14px;">
          <el-col :span="12">
            <div>
              <span>制单日期*：</span>
              <el-input v-model="input10" size="mini" style="width:350px;" placeholder="请输入内容"></el-input>
            </div>
          </el-col>
      ...
      <el-row>
        <el-col :span="24">
          ...
          >
            ...
            <el-table-column type="index" width="160px" label="调拨数量*"></el-table-column>
            <el-table-column type="index" width="160px" label="调拨单价*"></el-table-column>
            <el-table-column type="index" width="160px" label="调拨金额*"></el-table-column>
            <el-table-column type="index" width="160px" label="已出库数量"></el-table-column>
            <el-table-column type="index" width="160px" label="已入库数量"></el-table-column>
          </el-table>
        </el-col>
      </el-row>
    </el-row>
