  ...
  <div>
        ...
        <form class="form-horizontal">
            ...
            <div class="col-md-3">
              ...
              <el-select v-model="value" clearable placeholder="请选择单况" slot="prefix" class="el-input el-input--prefix">
                <el-option :key="`已结案`" :label="已结案" :value="`已结案`">
                </el-option>
                <el-option :key="`未结案`" :label="未结案" :value="`未结案`">
                </el-option>
                <el-option :key="`无效`" :label="无效" :value="`无效`">
                </el-option>
              </el-select>
            </div>
            <!-- 根据供应商查询订单 -->
            ...
            <div class="col-md-3">
                <label>申请人</label>
              <el-input placeholder="申请人" v-model="input3">
                <i class="el-icon-search el-input__icon"
                  slot="suffix"
              ...
              <!-- 弹出框=>加载采购员 -->
              <el-dialog title="申请人" :visible.sync="dialogFormVisible2">
                <el-container >
                    <el-header class="col-md-12" >
    ...
    <table class="table table-hover table-striped  text-center">
      ...
      <thead>
        <tr>
          <td colspan="4">
            <label style="width:20%;"> 采购请购类型:</label
            ><input
          ...
          <!-- 弹出框=>加载请购类型 -->
              <el-dialog  title="采购请购类型" :visible.sync="dialogFormVisible3">
                <!-- 供应商查询显示框 -->
                <el-container >
                    <el-header class="col-md-12" >
                  ...
                  <input type="button" value="取消"  class="btn btn-info col-md-1" @click="dialogFormVisible3 = false" style="margin-left:5px">
                    <div class="form-group col-md-9">
                      <label>查询条件:</label>
					              <el-select v-model="value1" placeholder="请选择" style="width:25%" size="small">
                          <el-option key="类型编号" label="类型编号" value1="类型编号"></el-option>
                          <el-option key="类型名称" label="类型名称" value1="类型名称"></el-option>
                        </el-select>
                        <el-select v-model="value2" placeholder="请选择" style="width:20%" size="small">
                          <el-option key="模糊" label="模糊" value2="模糊"></el-option>
                          <el-option key="等于" label="等于" value2="等于"></el-option>
        ...
        <tr>
          <td colspan="7" class="text-left">
           <el-tabs type="border-card">
            <el-tab-pane label="明细"><PurchaseRequisitionList></PurchaseRequisitionList> </el-tab-pane>
            <el-tab-pane label="备注"><PurchaseRequisitionDesc></PurchaseRequisitionDesc></el-tab-pane>
          </el-tabs>
          </td>
        </tr>
        <tr>
      ...
      <tfoot>
        ...
        <tr>
          <td colspan="4" style="border:none">
            <label style="width:20%;"> 请购人员:</label>
            <select
          ...
          <td colspan="3" style="border:none">
            <label style="width:20%;"> 请购部门:</label>
            <select
              class="form-control"
              style="width:70%;display:inline"
              disabled="true"
        ...
        <tr>
          ...
          <td colspan="3" style="border:none">
            <label style="width:20%;"> 复核人员:</label
            > <select
              class="form-control"
              style="width:70%;display:inline"
              :disabled="isupdate"
...
import $ from "jquery";
import PurchaseRequisitionList from "./PurchaseRequisitionList.vue"
import PurchaseRequisitionDesc from "./PurchaseRequisitionDesc.vue"
export default {
  //import引入的组件需要注入到对象中才能使用
  components: {
    PurchaseRequisitionList:PurchaseRequisitionList,
    PurchaseRequisitionDesc:PurchaseRequisitionDesc
  },
  data() {
    //这里存放数据
    return {
