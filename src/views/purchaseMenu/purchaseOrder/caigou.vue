<template>
    <div class="div">
        <el-row :gutter="20">
            <el-col :span="24"><h2 style="color:#666666;">采购排行表</h2></el-col>
        </el-row>
        <el-row >
            ...
            <el-row >
                <el-row>
                    <el-col :span="12">
                        <div>
                           <span>物料区间：</span><el-input @focus="dialogTableVisible1 = true" v-model="input" size="mini" style="width:170px;"></el-input>To
                           <el-input v-model="input1" @focus="dialogTableVisible1 = true" size="mini" style="width:170px;"></el-input>
                        </div>
                    </el-col>
                    <el-col :span="12">
                        <div>
                            <span>日期选择：</span>
                            <el-date-picker v-model="value2" align="right" size="mini" style="width:170px;" type="date" placeholder="选择日期" :picker-options="pickerOptions"></el-date-picker>To
                            <el-date-picker v-model="value2" align="right" size="mini" style="width:170px;" type="date" placeholder="选择日期" :picker-options="pickerOptions"></el-date-picker>
                        </div>
                    </el-col>
        </el-row>
        <el-row :gutter="20">
                    <el-col :span="12">
                        <div>
                            <span>客户选择：</span>
                            <el-input @focus="dialogTableVisible3 = true" v-model="input1" size="mini" style="width:360px;"></el-input>
                        </div>
                    </el-col>
                    <el-col :span="12">
                        <div style="text-align:left;padding-left:15px;">
                            ...
                            <el-radio-group v-model="radio">
                                <el-input @focus="dialogTableVisible2 = true" v-model="input2" size="mini" style="width:360px;"></el-input>
                            </el-radio-group>
                        </div>
                    </el-col>
        </el-row>
        ...
        <el-dialog title="人员查询" :visible.sync="dialogTableVisible2">
            <el-row :gutter="20">
                <el-col style="font-size:14px;text-align:left;" :span="24">
                    ...
                    <el-button size="mini" type="primary" @click="dialogTableVisible2 = false">取 消</el-button>
                    查询条件：
        ...
        <el-dialog title="客户查询" :visible.sync="dialogTableVisible3">
            <el-row :gutter="20">
                <el-col style="font-size:14px;text-align:left;" :span="24">
                    ...
                    <el-button size="mini" type="primary" @click="dialogTableVisible3 = false">取 消</el-button>
                    查询条件：
