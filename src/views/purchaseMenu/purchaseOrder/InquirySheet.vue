  ...
  <div>
    <div class="container col-lg-12 text-center">
      <div class="row" style="border:1px dashed rgba(170,170,170,0.8);padding-bottom:10px">
        <form class="form-horizontal">
            ...
            <div class="col-md-3">
                <label>审批状态</label>
              <el-select v-model="value" clearable placeholder="请选择状态" slot="prefix" class="el-input el-input--prefix">
            ...
            <div class="col-md-3">
                <label>询价员</label>
              <el-input placeholder="询价员" v-model="input3">
                <i class="el-icon-search el-input__icon"
                  slot="suffix"
              ...
              <!-- 弹出框=>加载采购员 -->
              <el-dialog title="询价员" :visible.sync="dialogFormVisible2">
                <el-container >
                    <el-header class="col-md-12" >
                         ...
                         :default-openeds="opens">
                           <el-submenu index="1">
                            ...
                            <template slot="title">
                             ...
                             <el-menu-item index="1-2-2">询价员</el-menu-item>
                            </el-submenu>
                            </el-submenu>
                        </el-menu>
                  </el-aside>
    ...
    <table class="table table-hover table-striped  text-center">
      ...
      <thead>
        ...
        <tr>
          <td colspan="4" style="border:none">
            <label style="width:20%;"> 有效日期:</label
            ><el-date-picker
            v-model="valueDate1"
            type="date"
      ...
      <tbody>
        <tr>
          <td colspan="7" class="text-left">
            ...
            <el-tab-pane label="明细"><InquirySheetList></InquirySheetList> </el-tab-pane>
            <el-tab-pane label="备注"><InquirySheetDesc></InquirySheetDesc></el-tab-pane>
          </el-tabs>
          </td>
        </tr>
        <tr>
      ...
      <tfoot>
        <tr>
          <td colspan="4">
              <label style="width:20%;"> 送货地址:</label
            ><select class="form-control"
              style="width:70%;display:inline"
              :disabled="isupdate">
              <option>地址1</option>
...
import $ from "jquery";
import InquirySheetList from "./InquirySheetList.vue"
import InquirySheetDesc from "./InquirySheetDesc.vue"
export default {
  //import引入的组件需要注入到对象中才能使用
  components: {
    InquirySheetList:InquirySheetList,
    InquirySheetDesc:InquirySheetDesc,
  },
  data() {
    //这里存放数据
    return {
