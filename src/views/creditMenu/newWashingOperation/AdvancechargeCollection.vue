  ...
  <div>
    ...
    <el-card class="box-card">
      <div slot="header" class="clearfix">
        <span class="el-icon-star-on">应收冲款单</span>
      </div>
      <!-- 头部表单 -->
      <div>
        <el-form
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="折扣率(%)" prop="delivery">
                <el-input v-model="ruleForm.resource" style="width:350px" placeholder="0.00"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
                ...
                <el-tabs v-model="activeName" @tab-click="handleClick">
                  <el-tab-pane label="内容" name="second">
                    ...
                    >
                      ...
                      <el-table-column prop="address" label="(原单日期)" width="140" sortable></el-table-column>
                      ...
                      <el-table-column prop="address" label="(原单金额)" width="140" sortable></el-table-column>
                  ...
                  <el-tab-pane label="取用预收" name="third">
                    <el-table
                      show-summary
                      contenteditable="true"
                      :data="tableData"
